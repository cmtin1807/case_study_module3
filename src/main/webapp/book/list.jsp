        ...
        <table class="table table-striped">
            ...
            <c:forEach var="book" items="${books}">
                <tr>
                    ...
                    <td><a href="<c:url value='/books?action=view&id=${book.id}'/>"
                           class="btn btn-primary btn-sm">View</a></td>
                    <td>
                        <a href="<c:url value='/books?action=edit&id=${book.id}'/>"
        ...
        <div class="pagination">
            <ul class="pagination">
                <c:if test="${currentPage > 1}">
                    <li class="page-item">
                        <a class="page-link" href="<c:url value='/books?page=${currentPage - 1}'/>"
                           aria-label="Previous">
